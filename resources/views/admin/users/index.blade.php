<x-admin-layout>
    <div class="py-2 max-w-12xl mx-auto lg:px-2">
        <div class="flex justify-between bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            @can('create-user')
                <div class="p-4">
                    {{-- <Link href="{{ route('admin.users.create')}}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded text-white">New User Old</Link> --}}
                    <Link modal href="/admin/users/create" class="p-3 bg-sky-400 hover:bg-sky-600 text-white rounded w-full font-semibold">New User</Link>
                </div>                    
            @endcan
        </div>
        <div class="py-2">
                ...
                <x-splade-table :for="$users">
                    ...
                    <style>
                        ...
                        <Link 
                            ...
                            confirm-button="Yes, I want delete this user!"
                            cancel-button="No, keep me save!">
                            <div class="[transform:perspective(50px)_translateZ(0)_rotateX(10deg)] group-hover:[transform:perspective(0px)_translateZ(0)_rotateX(0deg)] absolute bottom-0 mb-6 origin-bottom transform rounded text-white opacity-0 transition-all duration-300 group-hover:opacity-100">
                                <div class="flex max-w-xs flex-col items-center">
                                    <div class="rounded bg-gray-900 p-2 text-xs text-center shadow-lg">Delete User</div>
                                    <div class="clip-bottom h-2 w-4 bg-gray-900"></div>
                                </div>
                            </div>
                            <svg 
