<x-admin-layout>
    <x-splade-modal>
        <div class="py-2">
            <h1 class="text-2xl font-semibold p-4">Update Permission</h1>    

        </div>
        <x-splade-form :action="route('admin.permissions.update', $permission)" :default="$permission" method="PUT" class="p-4 bg-white rounded-md space-y-2">
