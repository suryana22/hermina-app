<x-admin-layout>
    <x-splade-modal>
        <div class="py-2">
            <h1 class="text-2xl font-semibold p-4">Update Role</h1>    

        </div>
        <x-splade-form :action="route('admin.roles.update', $role)" :default="$role" method="PUT" class="p-4 bg-white rounded-md space-y-2">
