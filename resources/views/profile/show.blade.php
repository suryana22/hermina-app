            ...
            <div class="bg-white rounded-lg shadow-xl pb-8">
                ...
                <div class="flex flex-col items-center -mt-20">
                    ...
                    <div class="flex items-center space-x-2 mt-2">
                        <p class="text-2xl">{{Auth::user()->firstname}}</p>
                        {{-- Tambah if user status  --}}
                        {{-- @role(['admin','user','IT Support']) --}}
                        ...
                        @else
                        <span class="bg-red-500 rounded-full p-1" title="Belum Aktivasi">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="4" stroke="currentColor" class="text-gray-100 h-3.5 w-3.5">
                    ...
                    <p class="text-gray-700">Departement</p>
                    ...
                    <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                        ...
                        <ul class="mt-2 text-gray-700">
                            <li class="flex border-y py-2">
                                ...
                                <span class="text-gray-700">{{Auth::user()->firstname}} {{Auth::user()->lastname}}</span>
                            </li>
                            <li class="flex border-b py-2">
                                <span class="font-bold w-24">Birthday:</span>
                                <span class="text-gray-700">{{Auth::user()->birthdate}}</span>
                            </li>
                            <li class="flex border-b py-2">
