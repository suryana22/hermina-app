<x-guest-layout>
    <x-auth-card>
        <x-splade-form action="{{ route('register') }}" class="space-y-4">
            ...
            <x-splade-input id="firstname" type="text" name="firstname" :label="__('First Name')" required autofocus />
            <x-splade-input id="lastname" type="text" name="lastname" :label="__('Last Name')" required autofocus />
